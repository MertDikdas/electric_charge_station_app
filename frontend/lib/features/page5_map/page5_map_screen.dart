...
class _MapScreenState extends State<MapScreen> {
            ...
            children: [
              ...
              for (final vehicle in _vehicles)
                ListTile(
                  ...
                  title: Text(vehicle.model.isEmpty ? vehicle.plate : vehicle.model),
                  subtitle: Text(
                    [
                      vehicle.plate,
  ...
  _ReservationSlot _nextReservationSlot() {
    ...
    return _ReservationSlot(start: start, end: start.add(const Duration(hours: 1)));
  }
